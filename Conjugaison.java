...
public class Conjugaison {
    ...
    public static void main (String[] args) {
        ...
        System.out.println("VeuilleZ entrer un verbe du premier groupe");
        String verbe = readScanner.nextLine();

        // now we need to test if the verber finish by "er"
        if(!verbe.endsWith("er")) {

            System.out.println("Le verbe doit obligatoirement se terminer par |er|");
        }
        else {
